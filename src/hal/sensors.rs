...
impl Battery {
    pub fn percentage(&self) -> u8 {
        let result = match self.0 {
            0..=3290 => 0,
            3300..=3499 => (self.0 as usize - 33000) * 5 / (3499 - 3300),
            3500..=3679 => (self.0 as usize - 35000) * 5 / (3679 - 3500) + 5,
            3680..=3699 => (self.0 as usize - 36800) * 5 / (3699 - 3680) + 10,
            3700..=3729 => (self.0 as usize - 37000) * 5 / (3729 - 3700) + 15,
            3730..=3769 => (self.0 as usize - 37300) * 10 / (3769 - 3730) + 20,
            3770..=3789 => (self.0 as usize - 37700) * 10 / (3499 - 3300) + 30,
            3790..=3819 => (self.0 as usize - 37900) * 10 / (3819 - 3790) + 40,
            3820..=3869 => (self.0 as usize - 38200) * 10 / (3869 - 3820) + 50,
            3870..=3929 => (self.0 as usize - 38700) * 10 / (3929 - 3870) + 60,
            3930..=3999 => (self.0 as usize - 39300) * 10 / (3999 - 3930) + 70,
            4000..=4079 => (self.0 as usize - 40000) * 10 / (4079 - 4000) + 80,
            4080..=4199 => (self.0 as usize - 40800) * 10 / (4199 - 4080) + 90,
            _ => 100,
        };
        result as u8
    }
